...
export default async function SubcategoryPage({ params, searchParams }: PageProps) {
  ...
  if (!(DEFAULT_APPLIED_PARAM in search) && isLeafItem("plywood-laminates", categoryName)) {
    ...
    redirect(`/products/items/plywood-laminates/${subcategory}?${query.toString()}`);
  }

  return (
    <ProductListing
      category={categoryName}
      breadcrumb={getFolderBreadcrumb("plywood-laminates", categoryName)}
    />
  );
}
