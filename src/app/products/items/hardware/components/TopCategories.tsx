      ...
      <div className="mx-auto w-full max-w-[1400px]">
        ...
        <div className="mb-8 sm:mb-10">
          ...
          <p
            ...
            "
          >
            Explore essential hardware, fittings and accessories designed for furniture, kitchens, wardrobes and modern interior projects.
          </p>
        </div>
