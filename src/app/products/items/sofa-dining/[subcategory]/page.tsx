...
export default async function SubcategoryPage({ params, searchParams }: PageProps) {
  ...
  if (!(DEFAULT_APPLIED_PARAM in search) && isLeafItem("sofa-dining", categoryName)) {
    ...
    redirect(`/products/items/sofa-dining/${subcategory}?${query.toString()}`);
  }

  return (
    <ProductListing
      category={categoryName}
      breadcrumb={getFolderBreadcrumb("sofa-dining", categoryName)}
    />
  );
}
