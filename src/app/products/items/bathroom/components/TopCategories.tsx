...
const categories = [
  {
    id: 1,
    name: "Bath Faucets",
    description: "Stylish fittings for comfortable everyday use.",
    image:
  ...
  },
  {
    ...
    href: "/products/items/bathroom/spares-and-fittings",
  },
  {
    id: 4,
    name: "Tiles Tools & Accessories",
    ...
    href: "/products/items/bathroom/tiles-tools-and-accessories",
  },
];
      ...
      <div className="mx-auto w-full max-w-[1400px]">
        ...
        <div className="mb-8 sm:mb-10">
          ...
          <p
            ...
            "
          >
            Explore bath accessories, faucets, toilets, tiles, cabinets, wash basins, mirrors and essential fittings designed for modern bathrooms.
          </p>
        </div>
