...
export default async function SubcategoryPage({ params, searchParams }: PageProps) {
  ...
  if (!(DEFAULT_APPLIED_PARAM in search) && isLeafItem("lighting-fans", categoryName)) {
    ...
    redirect(`/products/items/lighting-fans/${subcategory}?${query.toString()}`);
  }

  return (
    <ProductListing
      category={categoryName}
      breadcrumb={getFolderBreadcrumb("lighting-fans", categoryName)}
    />
  );
}
