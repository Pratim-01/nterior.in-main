      ...
      <div className="mx-auto w-full max-w-[1400px]">
        ...
        <div className="mb-8 sm:mb-10">
          ...
          <p
            ...
            "
          >
            Explore stylish kitchen solutions, practical storage and essential fittings designed for modern kitchens, everyday cooking and beautiful interiors.
          </p>
        </div>
