...
export default function KayapalatProducts() {
    ...
    useEffect(() => {
        async function fetchProducts() {
            try {
                ...
                const response = await fetch("/api/kayapalat-products");
    ...
    return (
        ...
        ===================================================== */}
              ...
              "
                        >
                            Discover quality products selected for furniture, kitchens,
                            wardrobes and modern interior projects.
                        </p>
                    </div>
